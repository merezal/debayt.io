            ...
            return (
                <div id="modalBlock"  >
                    ...
                    <span className="BubbleInput">
                        <TextField id="filled-textarea" margin="normal" multiline label="Enter Message" variant="filled" value={this.state.text} onInput={this.handleText} onKeyUp={(e) => { if (e.key == "Escape") { this.toggleVis(e) }}} autoFocus />
                    </span>
                </div>
            );
    }
